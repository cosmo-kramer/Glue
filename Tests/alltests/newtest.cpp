...
TEST (newtest, gcd){	
	system("../translator  alltests/gcd.py");   

	

	std::string input_src1;
	if (FILE *fp = fopen("alltests/gcd.cpp","r"))
	{
		char buf[chunk];
		while (size_t len = fread(buf, 1, sizeof(buf), fp))
			input_src1.insert(input_src1.end(), buf, buf + len);
	...
	std::string input_src2;
	if (FILE *fp = fopen("alltests/gcdexpect.cpp","r"))
	{
		char buf[chunk];
		while (size_t len = fread(buf, 1, sizeof(buf), fp))
			input_src2.insert(input_src2.end(), buf, buf + len);
...
TEST (newtest, cout){	
	system("../translator  alltests/cout.py");   

	

	std::string input_src1;
	if (FILE *fp = fopen("alltests/cout.cpp","r"))
	{
		char buf[chunk];
		while (size_t len = fread(buf, 1, sizeof(buf), fp))
			input_src1.insert(input_src1.end(), buf, buf + len);
	...
	std::string input_src2;
	if (FILE *fp = fopen("alltests/coutexpect.cpp","r"))
	{
		char buf[chunk];
		while (size_t len = fread(buf, 1, sizeof(buf), fp))
			input_src2.insert(input_src2.end(), buf, buf + len);
...
TEST (newtest, ifcomment){	
	system("../translator  alltests/ifcomment.py");   

	

	std::string input_src1;
	if (FILE *fp = fopen("alltests/ifcomment.cpp","r"))
	{
		char buf[chunk];
		while (size_t len = fread(buf, 1, sizeof(buf), fp))
			input_src1.insert(input_src1.end(), buf, buf + len);
	...
	std::string input_src2;
	if (FILE *fp = fopen("alltests/ifcommentexpect.cpp","r"))
	{
		char buf[chunk];
		while (size_t len = fread(buf, 1, sizeof(buf), fp))
			input_src2.insert(input_src2.end(), buf, buf + len);
...
TEST (newtest, towerhanoi){	
	system("../translator  alltests/towerhanoi.py");   

	

	std::string input_src1;
	if (FILE *fp = fopen("alltests/towerhanoi.cpp","r"))
	{
		char buf[chunk];
		while (size_t len = fread(buf, 1, sizeof(buf), fp))
			input_src1.insert(input_src1.end(), buf, buf + len);
	...
	std::string input_src2;
	if (FILE *fp = fopen("alltests/towerhanoiexpect.cpp","r"))
	{
		char buf[chunk];
		while (size_t len = fread(buf, 1, sizeof(buf), fp))
			input_src2.insert(input_src2.end(), buf, buf + len);
...
TEST (newtest, reg){	
	system("../translator  alltests/reg.py");   

	

	std::string input_src1;
	if (FILE *fp = fopen("alltests/reg.cpp","r"))
	{
		char buf[chunk];
		while (size_t len = fread(buf, 1, sizeof(buf), fp))
			input_src1.insert(input_src1.end(), buf, buf + len);
	...
	std::string input_src2;
	if (FILE *fp = fopen("alltests/regexpect.cpp","r"))
	{
		char buf[chunk];
		while (size_t len = fread(buf, 1, sizeof(buf), fp))
			input_src2.insert(input_src2.end(), buf, buf + len);
...
TEST (newtest, swap){	
	system("../translator  alltests/swap.py");   

	

	std::string input_src1;
	if (FILE *fp = fopen("alltests/swap.cpp","r"))
	{
		char buf[chunk];
		while (size_t len = fread(buf, 1, sizeof(buf), fp))
			input_src1.insert(input_src1.end(), buf, buf + len);
	...
	std::string input_src2;
	if (FILE *fp = fopen("alltests/swapexpect.cpp","r"))
	{
		char buf[chunk];
		while (size_t len = fread(buf, 1, sizeof(buf), fp))
			input_src2.insert(input_src2.end(), buf, buf + len);
